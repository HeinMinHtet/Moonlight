...
export function RateSettingsPage({
  ...
  return (
    <section className="tab-panel active rate-settings-page space-y-4">
      <header className="rate-page-head">
        <div className="flex flex-col gap-0.5">
          <div className="flex items-center gap-2.5">
            <h2 className="text-lg font-bold tracking-tight text-foreground sm:text-xl">Default rates & options</h2>
      ...
      {/* Bottom row: Supplier guilds and Armor stack options side-by-side */}
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-2" aria-label="Guild and armor stack options">
        <SupplierGuildsPanel
          rows={supplierGuilds}
        ...
        <ArmorStacksPanel
          ...
          disabled={!canEditPrices}
          onAdd={onAddArmorRow}
          onToggle={onToggleArmorRow}
          onDelete={onDeleteArmorRow}
