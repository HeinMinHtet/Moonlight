  ...
  if (isPostgres()) {
    ...
    try {
      await client.query(`
        ...
        CREATE INDEX IF NOT EXISTS idx_external_expenses_date ON external_expenses(date);
        CREATE INDEX IF NOT EXISTS idx_external_expenses_category ON external_expenses(category);
